...
printerOnButton = Button(win, text = "Turn Printer On", font = otherFont, command = set_print_on)
printerOffButton = Button(win, text = "Turn Printer Off", font = otherFont, command = set_print_off)
